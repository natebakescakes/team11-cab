...
<div class="row">
	<div style="max-width: 300px; margin: auto">
		...
		<form:form modelAttribute="facility"
			action="${pageContext.request.contextPath}/admin/facilities/create"
			method="POST">
			...
			<div class="form-group">
				<div class="input-group">
					...
					<div class="input-group-btn">
						<a
							href="${pageContext.request.contextPath}/admin/facilities/types"
							class="btn btn-default"><i style="padding: 3px" class="fa fa-pencil"></i></a>
					</div>
				</div>
			</div>
			<div class="form-group">
