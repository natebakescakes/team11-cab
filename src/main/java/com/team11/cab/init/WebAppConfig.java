...
@ComponentScan(basePackages = "com.team11.cab")
@PropertySource({ "classpath:application.properties", "classpath:/i18n/messages.properties" })
@EnableJpaRepositories("com.team11.cab.repository")
public class WebAppConfig extends WebMvcConfigurerAdapter {
	...
	public void addResourceHandlers(ResourceHandlerRegistry registry) {
		...
		registry.addResourceHandler("/slick-1.8.1/**").addResourceLocations("/slick-1.8.1/");
